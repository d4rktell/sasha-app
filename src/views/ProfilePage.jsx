      ...
      <Flex flexDir="column" p="15px" maxW="600px">
        <Flex position="relative" flexDir={{ base: 'column', sm: 'row' }} gap="20px">
          ...
          <Box w="100%">
            ...
            <Text pb={'3px'} mt="8px" textAlign="left" borderBottom="1px" borderColor="#0BC5EA">
              Name: {user?.name}
            </Text>
            <Text pb={'3px'} mt="8px" textAlign="left" borderBottom="1px" borderColor="#0BC5EA">
              Email: {user?.email}
            ...
            <Text pb={'3px'} mt="8px" textAlign="left" borderBottom="1px" borderColor="#0BC5EA">
              Role: {user?.role === 2 ? 'Студент' : 'Викладач'}
            </Text>
          </Box>
        </Flex>
        <Box bg="#e3e3e3" h="100px" p="10px" mt="15px" borderRadius="8px">
          <Text textAlign="left">Детальна інформація про користувача прихована</Text>
        </Box>
      </Flex>
    </Header>
  );
